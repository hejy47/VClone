            ...
            if (DiffEntryFilter.filterHdlFile(diffentry) and DiffEntryFilter.filterModifyType(diffentry)):
                ...
                if (revisedFileContent != "" and previousFileContent != ""):
                    ...
                    for revisedIncludeFile in revisedIncludeFiles:
                        ...
                        tmpIncludeFiles = re.findall("`include \"(.+?)\"", revisedIncludeFileContent)
                        for tmpIncludeFile in tmpIncludeFiles:
                            if tmpIncludeFile not in revisedIncludeFiles:
                                revisedIncludeFiles.append(tmpIncludeFile)
